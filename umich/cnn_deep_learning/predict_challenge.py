...
Predict Challenge
    ...
    predictions to disk
    Usage: python predict_challenge.py --username=<username> [--cuda]
"""
...
def main(username, cuda):
    ...
    pd_writer.to_csv(username + gpu_str + ".csv", index=False,)
